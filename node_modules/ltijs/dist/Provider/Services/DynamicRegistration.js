...
var _d2lkeysetUrl = /*#__PURE__*/new WeakMap();
...
class DynamicRegistration {
  constructor(options, routes, registerPlatform, getPlatform, ENCRYPTIONKEY, Database) {
    ...
    _classPrivateFieldInitSpec(this, _d2lkeysetUrl, {
      writable: true,
      value: void 0
    });
    ...
    (0, _classPrivateFieldSet2.default)(this, _d2lkeysetUrl, buildUrl(options.url, routes.d2lkeysetRoute));
  ...
  async register(openidConfiguration, registrationToken, options) {
    ...
    const registration = {
      ...
      jwks_uri: (0, _classPrivateFieldGet2.default)(this, _d2lkeysetUrl),

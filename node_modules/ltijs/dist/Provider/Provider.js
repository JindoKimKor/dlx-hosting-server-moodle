...
var _d2lkeysetRoute = /*#__PURE__*/new WeakMap();
...
class Provider {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _d2lkeysetRoute, {
      writable: true,
      value: '/jwks'
    });
  ...
  setup(encryptionkey, database, options) {
    ...
    if (options && options.dynReg) {
      const routes = {
        ...
        d2lkeysetRoute: (0, _classPrivateFieldGet2.default)(this, _d2lkeysetRoute)
      };
      /**
    ...
    const sessionValidator = async (req, res, next) => { 
      ...
      if (req.path === (0, _classPrivateFieldGet2.default)(this, _loginRoute) || req.path === (0, _classPrivateFieldGet2.default)(this, _keysetRoute) || req.path === (0, _classPrivateFieldGet2.default)(this, _d2lkeysetRoute) || req.path === (0, _classPrivateFieldGet2.default)(this, _dynRegRoute)) return next();
    ...
    this.app.all((0, _classPrivateFieldGet2.default)(this, _loginRoute), async (req, res) => {
      ...
      try {
        ...
        if (platform) {
          ...
          provMainDebug(query);
          try {
            const authEndpoint = await platform.platformAuthEndpoint();
            provMainDebug('Auth Endpoint:', authEndpoint);
          
            const redirectUrl = url.format({
              pathname: authEndpoint,
              query
            });
            provMainDebug('Redirecting to:', redirectUrl);
            res.redirect(redirectUrl);
          
            provMainDebug('Response Status after redirection:', res.statusCode);
          } catch (error) {
            provMainDebug('Error during redirection:', {
    ...
    this.app.get((0, _classPrivateFieldGet2.default)(this, _d2lkeysetRoute), async (req, res, next) => {
      return (0, _classPrivateFieldGet2.default)(this, _keyset).call(this, req, res, next);
    });
